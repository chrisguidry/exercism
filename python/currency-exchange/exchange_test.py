    ...
    def test_get_value_of_bills(self):
        ...
        for variant, (input_data, output_data) in enumerate(
            ...
            with self.subTest(
                ...
                self.assertEqual(
                    get_value_of_bills(input_data[0], input_data[1]), output_data
                )
    ...
    def test_get_number_of_bills(self):
        ...
        for variant, (input_data, output_data) in enumerate(
            ...
            with self.subTest(
                ...
                self.assertEqual(
                    get_number_of_bills(input_data[0], input_data[1]), output_data
                )
    ...
    def test_get_leftover_of_bills(self):
        ...
        for variant, (input_data, output_data) in enumerate(
            ...
            with self.subTest(
                ...
                self.assertAlmostEqual(
                    get_leftover_of_bills(input_data[0], input_data[1]), output_data
                )
